...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/Karan_ContactBot")]])
keyboard = InlineKeyboardMarkup(
    [
        [InlineKeyboardButton(text="🛠️ Help", url="https://t.me/Karan_ContactBot"), InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/+nJQvEUG5ya43YTk9")],
    ]
)
...
image_urls = [
    ...
    "https://telegra.ph/file/3ab7d6e405e92c3e72141.jpg",
...
async def start(bot, m: Message):
    ...
    start_message = await bot.send_photo(
        chat_id=m.chat.id,
        photo="https://telegra.ph/file/3ab7d6e405e92c3e72141.jpg",
        caption=caption
    )
    ...
    if m.chat.id in AUTH_USERS:
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton(text="📞 Contact", url=f"tg://openmessage?user_id={OWNER}"), InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/+nJQvEUG5ya43YTk9")],
        ])
...
async def help_button(client, callback_query):
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://telegra.ph/file/3ab7d6e405e92c3e72141.jpg",
      caption=caption
    ),
    reply_markup=keyboard
    )
